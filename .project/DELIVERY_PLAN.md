...
| Identity and authorization              | Spine foundations verified; authenticated staging E2E pending          | Authentication, tenant isolation, database/server enforcement, admin/full-view plus part/program/department/technical-team scopes, combinations, permission audit.                                                                                                                                                         |
